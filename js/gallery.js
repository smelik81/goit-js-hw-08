...
containerGallery.addEventListener('click', handleImageModal)
...
function handleImageModal(event) {
    if (event.target === event.currentTarget) {
        return;
    } 

    const imageItem = event.target.dataset.source;
    const modalImage = images.find(item => item.original === imageItem); // хоча впринципі можно не створювати додаткову змінну і використовувати посилання отримане в imageItem;
